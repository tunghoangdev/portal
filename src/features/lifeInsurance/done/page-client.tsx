...
import { LifeContractAckForm } from '~/components/common/forms/life-contract-ack.form';
...
export default function PageClient() {
	...
	const { columns, logColumns } = useTableColumns(processingColumns, {
		showMonthYear: true,
		showLevel: true,
		actions: [CRUD_ACTIONS.LOG, CRUD_ACTIONS.VIEW, CRUD_ACTIONS.UPDATE_ACK, CRUD_ACTIONS.COMMISON_LIST],
	});
	// CRUD HOOK
