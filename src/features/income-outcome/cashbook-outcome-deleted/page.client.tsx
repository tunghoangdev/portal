...
import { getColumns, incomeOutcomeColumns } from "~/features/shared/common";
...
const MODAL_TITLE = " phiếu chi đã xóa";
...
export default function PageClient() {
  ...
  const basePath = API_ENDPOINTS[role].incomeOutcome.cashbookOutcomeDeleted;
  // CRUD HOOKS
