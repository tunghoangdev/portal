...
export const RoleList = ({ idPermission }: any) => {
	...
	const allowButton = role === ROLES.SAMTEK ? CRUD_ACTIONS.SAMTEK_PERMISSION_BUTTON : CRUD_ACTIONS.PERMISSION_BUTTON;
	const removeButton = role === ROLES.SAMTEK ? CRUD_ACTIONS.SAMTEK_REMOVE_PERMISSION_BUTTON : CRUD_ACTIONS.REMOVE_PERMISSION_BUTTON;
	const allowForm = role === ROLES.SAMTEK ? CRUD_ACTIONS.SAMTEK_PERMISSION_FORM : CRUD_ACTIONS.PERMISSION_FORM;
	const removeForm = role === ROLES.SAMTEK ? CRUD_ACTIONS.SAMTEK_REMOVE_PERMISSION_FORM : CRUD_ACTIONS.REMOVE_PERMISSION_FORM;
