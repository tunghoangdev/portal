...
interface CommissionTypeFieldProps<TFormValues extends FieldValues>
...
export function CommissonTypeField<TFormValues extends FieldValues>({
	name,
	control,
	defaultOption,
	label,
	...
	isDisabled,
	placeholder,
}: CommissionTypeFieldProps<TFormValues>) {
	const { commissionTypes } = useCommon();
	const { isFetching } = useCommonData(
		'commissionTypes',
		API_ENDPOINTS.dic.commissionType,
		{
			enabled: true,
		},
	);
