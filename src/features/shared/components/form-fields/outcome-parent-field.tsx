...
export function OutcomeParentField<TFormValues extends FieldValues>({
	name,
	control,
	defaultOption,
	label,
	...
	const { outcomeParentList } = useCommon();
	const { isFetching } = useCommonData(
		'outcomeParentList',
		API_ENDPOINTS.dic.outcomeParent,
		{
			enabled: !outcomeParentList,
		},
	);
