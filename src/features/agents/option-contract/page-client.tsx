...
import { COMPLETED, listColumns } from './columns';
...
const columns = getColumns<any>(listColumns, {
	actions: [
		CRUD_ACTIONS.DOWLOAD_E_CONTRACT,
		CRUD_ACTIONS.RESIGN_CONTRACT,
		// CRUD_ACTIONS.EDIT,
		// CRUD_ACTIONS.DELETE,
	],
});
export default function PageClient() {
	...
	// Local state
	const basePath = API_ENDPOINTS[role].agents.optionContract;
	// CRUD HOOKS
			...
			if (action === CRUD_ACTIONS.RESIGN_CONTRACT) {
				await updateConfirm(
					...
					},
					{
						...
						_customUrl: basePath.reSingOptionContract,
					},
				);
				return;
			}
