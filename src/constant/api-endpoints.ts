...
export const API_ENDPOINTS: Record<string, any> = {
	...
	samtek: {
		...
		customers: {
			...
			configBusiness: '/customer_receipt/list',
			orderList: '/customer_receipt_all/list',
		...
		products: {
			dic: '/product_start/dic',
			create: '/product_start/add',
			update: '/product_start/update',
			delete: '/product_start/remove',
			logList: '/product_start/log_list',
		},
	},
};
